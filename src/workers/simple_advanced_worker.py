#!/usr/bin/env python3
"""
Worker semplificato per traduzione documenti (nativi + scannerizzati)
Versione senza dipendenze problematiche
"""
...
class SimpleAdvancedWorker(QThread):
    """Worker semplificato per traduzione documenti con supporto OCR"""
...
if __name__ == "__main__":
    ...
    print("Worker semplificato inizializzato")
    print(f"   OCR disponibile: {'Si' if OCR_AVAILABLE else 'No'}")
